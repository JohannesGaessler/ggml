...
extern "C" {
    ...
    enum ggml_opt_loss_type {
        ...
        GGML_OPT_LOSS_TYPE_MEAN_SQUARED_ERROR_REL_LABELS,
        GGML_OPT_LOSS_TYPE_MEAN_SQUARED_ERROR_REL_OUTPUTS,
        GGML_OPT_LOSS_TYPE_MEAN_SQUARED_LOGARITHMIC_ERROR,
        GGML_OPT_LOSS_TYPE_MEAN_SQUARED_ASYMMETRY,
        GGML_OPT_LOSS_TYPE_HETEROSCEDASTIC,
    };
